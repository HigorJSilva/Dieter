...
import { fieldSizeMessage, requiredMessage, unauthorizedError } from '../../helpers/ErrorMessages';
...
describe("Testing create property route for exception flows", function() {

  describe("Create property not provinding the required fields", function() {
    
    it("it should not create property when no name is provided", function() {
      requestData = {
  ...
  describe("Name provided is not valid", function() {
    ...
    it("it should not create property when name provided is too short", function() {
      requestData = {
        "name": "Ap",
        "address": "5th Avenue, 412", 
        "waterCompanyId": "1784-4",
  ...
  describe("Address provided is not valid", function() {
    ...
    it("it should not create property when address provided is too short", function() {
      requestData = {
  ...
  describe("Create property when user not logged in", function() {
    
    it("it should not create property when user is not logged in", function() {
      token = '';
      requestData = {
        "name": "Apartment 413, Wazowski Tower",
        "address": "5th Avenue, 412", 
...
describe("Testing create property routes for acceptance flow", function() {

  describe("Create property when required data only is provided", function() {

    it("it should return the created property info", function() {
      token = requestToken;
      requestData = {
        "name": "Apartment 413, Wazowski Tower",
      }
  ...
  describe("Create property when all fields are provided", function() {
